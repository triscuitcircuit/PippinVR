...
This project was created out of the frustration that all MacOS VR virtual screen software (_Meta Quest Remote Desktop_, _Immersed_) are proprietary pieces of software. If I have code recording my screen, I want to know what it is actually doing.
