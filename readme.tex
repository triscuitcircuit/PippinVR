...
\url{figures/pippin\_example.gif}
\section{About}
...
\item CMAKE ( \href{https://cmake.org/}{CMAKE.org} or by \href{https://formulae.brew.sh/formula/cmake}{Homebrew})
...
\begin{quote}
{[}!NOTE]
Make sure a \texttt{local.properties} in \texttt{pippinVR-client} file contains `sdk.dir` and points to the android sdk. An example file called \texttt{local.properties.example} is provided.
\end{quote}
\section{Design}
...
\end{center}
Actor diagram for lifetimes of the client. Showcases the loop of frame encoding and sending to the headset to \texttt{FrameSink}.
